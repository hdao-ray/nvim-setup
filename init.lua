...
require('lazy').setup({
...

  {
    ...
    dependencies = {
      ...
      {'L3MON4D3/LuaSnip',
      config = function() 
        require('lua\\plugins\\snippets\\snippets') end
    },
      'hrsh7th/cmp-buffer', 
...

  {
    ...
    config = function()
      ...
      -- Add custom rules for LaTeX pairs
      npairs.add_rules({
       -- Rule('$$', '$$', 'tex'),        -- $$ ... $$
        Rule('\\(', '\\)', 'tex'),      -- \( ... \)
        Rule('\\[', '\\]', 'tex'),      -- \[ ... \]
...
--vim.cmd('source C:\\Users\\raymo\\AppData\\Local\\nvim\\snippets\\snippets.lua')
--require('C:\\Users\\raymo\\AppData\\Local\\nvim\\snippets\\snippets')
